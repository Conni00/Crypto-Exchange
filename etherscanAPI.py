...
def get_bitcoin(address,startdate,enddate):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            #     print(f"Total value: {sum(output['value'] for output in tx['out']) / 100000000} BTC")
            #     print("-" * 60)
        else:
...
def main():
    ...
    get_bitcoin("34xp4vRoCGJym3xR7yCVPFHoCNxv4Twseo",start_date,end_date)
